test_that("wrapper of mixed-effects model works", {
  ...
  SSS=1
  result2=gibbs_crossgroup(N=N,p=p,g=g,r=r,YL=YL,Y=Y,Xtest=Xtest,Xadjust=Xadjust,grouplabel=grouplabel,c0=1,d0=0.001,c1=1,d1=0.001,niter=5,adjust=T,reff=T,SEED=SSS,pi_only=F,gprior_m=gprior_m,reffcov=model_index,lambda_fixed=lambda_fixed)
